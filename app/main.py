...
@app.get("/students/{student_id}", response_model=Student, summary="Buscar aluno por ID")
...
@app.post("/students", response_model=Student, status_code=201, summary="Criar novo aluno")
